...
import Class.ItemClass as IC

pygame.init()
class Main:

    def __init__(self, width=800, height=800, name="Lumi", fps=60):
        self.width = width
        self.height = height
        self.__name = name
        self.fps = fps
            ...
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_SPACE:
                    ...
                    if len(self.ulti) == 0 and len(self.projectiles) == 0 and self.__player.ultime_attack > 0:
                        print(f"ultime at w={pygame.mouse.get_pos()[0]}, y= {pygame.mouse.get_pos()[1]}") #DEV LOG
